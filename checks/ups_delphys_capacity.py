...
# upsBatteryStatus              1.3.6.1.4.1.4555.1.1.5.1.2.1
# upsSecondsOnBattery           1.3.6.1.4.1.4555.1.1.5.1.2.2
# upsEstimatedMinutesRemaining  1.3.6.1.4.1.4555.1.1.5.1.2.3
# upsEstimatedChargeRemaining   1.3.6.1.4.1.4555.1.1.5.1.2.4
# upsBatteryVoltage             1.3.6.1.4.1.4555.1.1.5.1.2.5
# upsBatteryTemperature         1.3.6.1.4.1.4555.1.1.5.1.2.6
...
check_info["ups_delphys_capacity"] = {
    ...
    "has_perfdata": True,
    "group": "ups_capacity",
    "snmp_info": (".1.3.6.1.4.1.4555.1.1.5.1.2", [2, 3, 4]),
